...
import { SocialLink, VTLink, VTSocialLinks } from '@vue/theme'
    ...
    <div class="profile">
      ...
      <div class="data">
        ...
        <p v-if="member.title || member.org" class="affiliation">
          ...
          <VTLink v-if="member.org" class="org" :class="{ link: member.orgLink }" :href="member.orgLink" no-icon>
            {{ member.org }}
          </VTLink>
        </p>
        ...
        <div v-if="member.links" class="links">
          <VTSocialLinks :links="member.links" />
        </div>
      </div>
    </div>
  </article>
