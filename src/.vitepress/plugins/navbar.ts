 ...
 * @LastEditors: Wibus
 * @LastEditTime: 2022-10-23 21:45:26
 * Coding With IU
 */
  ...
  return {
    ...
    transform(code, id) {
      if (id.includes('VPNavBarTitle.vue') && !id.endsWith('.css')) {
        return `
<template>
  <a class="VPNavBarTitle" href="https://mog.js.org" onclick="() => {window.open('https://mog.js.org')}">
<svg width="45px" height="35px" id="图层_1" data-name="图层 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 500"><defs>
